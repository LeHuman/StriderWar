...
namespace fixed {
    ...
    uint_t atan2(Fixed y, Fixed x) {
        ...
        uint_t baseAngle = atan2Table[index]; // range 0-65535 for 0-90°

        static const uint_t QUADRANT_ANGLE = ATAN2_LUT_SIZE / 4;
